...
import { Summary, Recommendation } from '@/types/analysis';
import HelpTooltip from './HelpTooltip';

interface CombinedExecutiveSummaryProps {
  summary?: Summary;
  recommendation?: Recommendation;
}

export default function CombinedExecutiveSummary({ summary, recommendation }: CombinedExecutiveSummaryProps) {
